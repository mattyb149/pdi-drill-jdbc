...
/**
 * Created by mburgess on 10/6/15.
 */
public class DrillDialect extends AbstractDatabaseDialect {

  private static final int DEFAULT_PORT = 2181; // Default ZooKeeper port

  private static final IDatabaseType DBTYPE = new DatabaseType( "Apache Drill", "DRILL", DatabaseAccessType.getList(
    DatabaseAccessType.NATIVE, DatabaseAccessType.JNDI ), DEFAULT_PORT,
    "http://drill.apache.org/docs/using-jdbc/" );
